<div class="team" id="team" style="margin-top: -40px;">
	<div class="container">
		<div class="team-grids">
		<div class="col-md-3 team-gds wow fadeInLeft animated" data-wow-delay=".5s">
			<div class="gal-grid-rev vertical">
				<div class="img-box-content"><img src="${pageContext.request.contextPath}/images/pending.png" alt=" "  style="height: 100px;" /></div>
			...
			<h4>
			<a href="${pageContext.request.contextPath}/admin/create-employee.htm">
					Create New Employee
			</a>
		...
		<div class="col-md-3 team-gds wow fadeInUp animated" data-wow-delay=".5s">
			<div class="gal-grid-rev vertical">
				<div class="img-box-content"><img src="${pageContext.request.contextPath}/images/account-approval.png" alt=" " style="height: 100px;"/></div>
					<div class="gal-text-box">
						<div class="info-gal-con">
							<div class="social-content">
								<ul>
			...
			<a href="${pageContext.request.contextPath}/employee/pendingSavingAccountRequests.htm">
				<h4>Account Approvals(100000000)</h4>
				</a>
		</div>
		<div class="col-md-3 team-gds wow fadeInDown animated three" data-wow-delay=".5s">
			<div class="gal-grid-rev vertical">
				<div class="img-box-content"><img src="${pageContext.request.contextPath}/images/accounts.png" alt=" " style="height: 100px;"/></div>
					<div class="gal-text-box">
						<div class="info-gal-con">
							<div class="social-content">
								<ul>
		...
		<a href="${pageContext.request.contextPath}/employee/approvedCustomersAccount.htm">
						<h4>Approved Accounts(67686)</h4>
			</a>
		</div>
		<div class="col-md-3 team-gds wow fadeInRight animated four" data-wow-delay=".5s">
			<div class="gal-grid-rev vertical">
				<div class="img-box-content"><img src="${pageContext.request.contextPath}/images/lock.png" alt=" "style="height: 100px;" /></div>
					<div class="gal-text-box">
						<div class="info-gal-con">
							<div class="social-content">
								<ul>
