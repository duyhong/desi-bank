		...
		$("#approveApplication").click(function(){
				var contextPath="${pageContext.request.contextPath}";
				 ...
				 /* jdata.forEach((item) => {
			   	 ...
			   	 //Converting html form data into JavaScript object
				 for(var x=0;x<jdata.length;x++){
						var name=jdata[x].name;
			   			var value=jdata[x].value;
			   			jsonData[name]=value;
			   	}
				 //JSON.stringify(jsobj) = coverts JavaScript object into JSON format
				 //JSON.parse(jsondata) = coverts JSON format into JavaScript object
...
<!--//team-->
<hr/>
<div class="team" id="team" style="margin-top: -118px;">
	<div class="container">
