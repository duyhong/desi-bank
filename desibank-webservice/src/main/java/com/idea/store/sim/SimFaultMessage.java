    ...
    extends Exception
{
     ...
     * @param faultInfo
     */
    public SimFaultMessage(String message, DetailMessage faultInfo) {
        super(message);
     ...
     * @param cause
     */
    public SimFaultMessage(String message, DetailMessage faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
